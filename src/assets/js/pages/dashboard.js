/**
* Theme: Tailzon - Tailwind CSS 3 Admin Layout & UI Kit Template
* Author: MyraStudio
...
var options = {
    ...
    colors: ["#6366f1", "#38bdf8", "#a78bfa"], // Tailwind's Pink, Sky, and Violet shades
    stroke: {
        lineCap: 'round'
    },
    series: [81, 70, 110],
...
var options = {
    ...
    colors: ["#6366f1", "#38bdf8"], // Tailwind's Pink and Sky shades
    dataLabels: {
        enabled: false,
    },
    stroke: {
